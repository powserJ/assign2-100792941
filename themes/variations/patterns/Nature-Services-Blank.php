<?php
/**
 * Title: Services Blank Page
 * Slug: variations/nature-services-blank
 * Description: Add an Services Blank Page
...
<h1 class="wp-block-heading has-text-align-center"><?php printf( esc_html__( '%s', 'variations' ), __( 'Services', 'variations' ) ); ?></h1>
<!-- /wp:heading -->
