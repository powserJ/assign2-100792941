...
<div id="email_remainder_block">
	<div class="attr-form-group etn-label-item">
		<div class="etn-label">
			<label>
				<?php esc_html_e('Disable Remainder Email', 'eventin'); ?>
			</label>
			<div class="etn-desc mb-2"> <?php esc_html_e('Do you want to send remainder email to event attendee?', 'eventin'); ?> </div>
		</div>
		<?php 
    	...
    	?>
		<div class="etn-meta">
			<input id="off_remainder" type="checkbox" <?php esc_attr_e($off_remainder == "yes" ? "checked" : "" ); ?> class="etn-admin-control-input" name="off_remainder"  value="yes" />
	...
	<div class="attr-form-group etn-label-item etn-label-top">
    	...
    	?>
		<div class="etn-meta">
			<textarea id='remainder_message' rows="10" cols="5" class="etn-setting-input etn-msg-box attr-form-control etn-recaptcha-secret-key" name="remainder_message" placeholder="<?php esc_html_e( 'Enter reminder email message.', 'eventin' );?>"><?php echo esc_html( $remainder_message ); ?></textarea>
		</div>
		<?php } ?>
	</div>
</div>
